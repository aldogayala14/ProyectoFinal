                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="hidden" name="id_habitacionReservaConfirm" value="<%=id%>">
                                                <% String idReservaHab = (String) mi_session.getAttribute("id_huespedReservaHab");%>
                                                <input type="hidden" name="id_huespedReservaConfirm" value="<%=idReservaHab%>">
                                                <% String idEmpleadoRes = (String) mi_session.getAttribute("id_empleadoReservaHab");%>
                                                <input type="hidden" name="id_empleadoReservaConfirm" value="<%=idEmpleadoRes%>">
